...
namespace OrderForm
{
    public partial class FormMain : Form
    {
        ...
        public void init()
        {
            Customer customer1 = new Customer(1, "liuwang", "13567261764");
            Customer customer2 = new Customer(2, "jams", "13267885564");
            ...
            Order order1 = new Order("2008-09-20-123", customer1);
            Order order2 = new Order("2008-09-20-124", customer2);
            Order order3 = new Order("2008-09-20-125", customer2);
        ...
        {
            orderService.Export(@"..\..\orders1.xml");
            XmlDocument doc = new XmlDocument();
            doc.Load(@"..\..\orders1.xml");
